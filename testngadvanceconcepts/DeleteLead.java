...
public class DeleteLead {
	...
	@Test(invocationCount = 4,invocationTimeOut = 80000)// Total execution will happen 4 times, 2 browsers will open parallel
	//threadPoolSize will work only with invocationCount
